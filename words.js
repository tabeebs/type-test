...
const WORDS = [
    ...
    'picture', 'being', 'study', 'second', 'soon', 'story', 'since', 'white', 'ever', 'paper',
    'hard', 'near', 'sentence', 'better', 'best', 'across', 'during', 'today', 'however', 'sure',
    'knew', 'it\'s', 'try', 'told', 'young', 'sun', 'thing', 'whole', 'hear', 'example',
    'heard', 'several', 'change', 'answer', 'room', 'sea', 'against', 'top', 'turned', 'learn',
    'point', 'city', 'play', 'toward', 'five', 'himself', 'usually', 'money', 'seen', 'didn\'t',
    'car', 'morning', 'I\'m', 'body', 'upon', 'family', 'later', 'turn', 'move', 'face',
    'door', 'cut', 'done', 'group', 'true', 'leave', 'sorry', 'stood', 'happen', 'carry',
    'took', 'matter', 'square', 'run', 'book', 'example', 'eat', 'far', 'sea', 'begin',
    'grow', 'took', 'river', 'open', 'walk', 'seem', 'together', 'next', 'white', 'children',
    'got', 'start', 'made', 'run', 'don\'t', 'talk', 'where', 'turn', 'every', 'came'
];
